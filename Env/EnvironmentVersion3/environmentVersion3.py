...
# w1, w2, w3,
class StockEnvTrainVersion3(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            info = {'mean reward': np.mean(self.rewards_memory), 'value_portfolio': self.P_t_0, 'reward': self.reward, 'weights': self.W_t, 'share_weight1': share_weight1,'share_weight2': share_weight2,'share_weight3': share_weight3, 'actions': actions }
