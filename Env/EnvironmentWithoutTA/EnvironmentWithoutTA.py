...
# w1, w2, w3,
class StockEnvTrainWithoutTA(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            pd.DataFrame({'sharpe':[sharpe],'PortfolioValue':[self.P_t_0],'trades':[self.trades]}).to_csv("results/Results_Train.csv",index=False, mode='a', header=False)
